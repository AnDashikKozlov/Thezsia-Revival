...
public class ThezProduction{
    ...
    public static void load(){
        windTrap = new GenericCrafter("large-wind-trap"){{
            ...
            consumePower(1.92f);
            outputLiquid = new LiquidStack(wind,1.11f);
            liquidCapacity = 300;
            ...
            drawer = new DrawMulti(new DrawRegion("-bottom"), new DrawLiquidTile(wind, 3), new DrawRegion("-bottom2"),
        ...
        stoneGrinder = new WallCrafter("stone-grinder"){{
            ...
            consume(new ConsumeLiquid(wind, 0.05f));
            drillTime = 220;
            output = nihilite;
