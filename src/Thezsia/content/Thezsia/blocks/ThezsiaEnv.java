...
public class ThezsiaEnv{
    public static Block
            ...
            //ores
            nihiliteOre, silverLick, tritaniumOre, tritaniumOreWall;
    public static void load(){
        ...
        charrokWall = new StaticWall("charrok-wall"){{variants = 4;
            charrokFloor.asFloor().wall = this;
        }};
        hardCharrokWall = new StaticWall("hard-charrok-wall"){{variants = 4;
        ...
        sulfurWall = new StaticWall("sulfur-wall"){{variants = 4;
        ...
        peridotiteWall = new StaticWall("peridotite-wall"){{variants = 4;
            peridotite.asFloor().wall = this;
        }};
        peridotiteDarkWall = new StaticWall("peridotite-dark-wall"){{variants = 4;
